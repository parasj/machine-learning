...
set CLASSPATH=%APP_HOME%\lib\code.jar;%APP_HOME%\lib\ABAGAIL.jar;%APP_HOME%\lib\guava-17.0.jar;%APP_HOME%\lib\weka-stable-3.6.10.jar;%APP_HOME%\lib\java-cup-0.11a.jar

@rem Execute code
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CODE_OPTS%  -classpath "%CLASSPATH%" com.proj3.Main %CMD_LINE_ARGS%
