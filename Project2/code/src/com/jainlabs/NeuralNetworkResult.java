...
public class NeuralNetworkResult {
    ...
    public String[] csvEntries() {
        return String.format("%d#%d#%d#%f#%d#%d#%d#%d", iterations, trainTimeNano / 1000000, testTimeNano / 1000000, accuracy(), truePositives, trueNegatives, falsePositives, falseNegatives).split("#");
    }

    public static String[] csvHeader() {
        return new String[] { "Iterations", "Train Time (ms)", "Test Time (ms)", "Accuracy", "True Positives", "True Negatives", "False Negatives", "False Positives" };
    }
