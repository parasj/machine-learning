...
//    private static final int NUM_ITEMS = 40;
    ...
    public static OptimizationResultTuple run(int NUM_ITEMS) {
        ...
        OptimizationResultTuple result = new OptimizationResultTuple(rhcr, sar, gar, mimicr);
        System.out.printf("%d: %s%n", NUM_ITEMS, result);
        return result;
    }
}
